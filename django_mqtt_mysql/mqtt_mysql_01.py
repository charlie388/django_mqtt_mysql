...
# The Google AI say after version 9.0.0 of "mysql-connector-python" without using "use_pure=True"
# It will fail on using windows mysql driver.
# Due to lattest supported "Microsoft Visual C++ Redistributable" not installed

    mycursor = mydb.cursor()

    mycursor.execute(f'SELECT VERSION()')
